namespace Stripe
{
        ...
        IUpdatable<CreditNote, CreditNoteUpdateOptions>
    {
        ...
        public virtual StripeList<CreditNoteLineItem> ListCreditNoteLineItems(string id, CreditNoteCreditNoteLineItemsListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request<StripeList<CreditNoteLineItem>>(HttpMethod.Get, $"{this.InstanceUrl(id)}/lines", options, requestOptions);
        }

        public virtual Task<StripeList<CreditNoteLineItem>> ListCreditNoteLineItemsAsync(string id, CreditNoteCreditNoteLineItemsListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual IEnumerable<CreditNoteLineItem> ListCreditNoteLineItemsAutoPaging(string id, CreditNoteLineItemListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListRequestAutoPaging<CreditNoteLineItem>($"{this.InstanceUrl(id)}/lines", options, requestOptions);
        }

        public virtual IAsyncEnumerable<CreditNoteLineItem> ListCreditNoteLineItemsAutoPagingAsync(string id, CreditNoteLineItemListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
